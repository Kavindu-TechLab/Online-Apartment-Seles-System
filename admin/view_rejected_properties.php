...
<body>
    <div class="container">
        ...
        <a class="logo1" href="admin_dashboard.php"><img src="../images/logo.png" alt="Logo"></a>
            <a href="view_rejected_properties.php"><h1 class="main-title">Rejected Listings</h1></a>
            ...
            <div class="all-listing-container">
                ...
                $sql = "SELECT * FROM listing_details WHERE approval_status = 'Rejected' ORDER BY date DESC";
                $result = $conn->query($sql);
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        echo'<div class="listing">';
                            ...
                            echo '</div>';
                            echo '<!-- Delete button -->';
                            echo '<form action="process_php/delete_rejectListing.php" method="post">';
